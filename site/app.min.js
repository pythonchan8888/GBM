            ...
            <div class="game-card game-card--v3" 
                ...
                <div class="game-row">
                    ...
                    <div class="game-matchup">
                        <div class="team-row">
                            <span class="${i}">${this.game.home}</span>
                            ${t}
                        </div>
                        <div class="vs-separator">vs</div>
                        <div class="team-row">
                            <span class="${s}">${this.game.away}</span>
                            ${a}
                        </div>
                    </div>
